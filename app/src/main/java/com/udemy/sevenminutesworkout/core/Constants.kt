package com.udemy.sevenminutesworkout.core
...
object Constants {
    ...
    fun defaultExerciseList(): ArrayList<ExerciseModel> {
        val exerciseList = arrayListOf(
            ...
            ExerciseModel(7, "Tricep Dip On Chair", R.drawable.ic_triceps_dip_on_chair, false,false),
            ExerciseModel(8, "Plank", R.drawable.ic_plank, false, false),
            ExerciseModel(9, "High Knees", R.drawable.ic_high_knees_running_in_place, false, false),
